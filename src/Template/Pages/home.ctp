...
<html lang="en">
  <head>
    ...
    <?php echo $this->Html->css(['bootstrap.min', 'font-awesome.min', 'style', 'responsive']); ?>
  ...
  <body> 
            ...
            <div class="block-slider block-slider4">
                <ul class="" id="bxslider-home4">
                    <li>
                         <?php
                            echo $this->Html->link(
                                $this->Html->image("h4-slide.png", ["alt" => "Slide"]),
                                "recipes/view/6",
                                ['escape' => false]
                            );
                            ?>
                    ...
                    <li>
                         <?php
                            echo $this->Html->link(
                                $this->Html->image("h4-slide2.png", ["alt" => "Slide"]),
                                "recipes/view/6",
                                ['escape' => false]
                            );
                            ?>
                    ...
                    <li>
                         <?php
                            echo $this->Html->link(
                                $this->Html->image("h4-slide3.png", ["alt" => "Slide"]),
                                "recipes/view/6",
                                ['escape' => false]
                            );
                            ?>
                    ...
                    <li>
                         <?php
                            echo $this->Html->link(
                                $this->Html->image("h4-slide4.png", ["alt" => "Slide"]),
                                "recipes/view/6",
                                ['escape' => false]
                            );
                            ?>
    ...
    <?php echo $this->Html->script('https://code.jquery.com/jquery.min.js'); ?>    
    ...
    <!-- Slider -->
    <?php echo $this->Html->script('bxslider.min.js'); ?> 
    <?php echo $this->Html->script('script.slide.js'); ?>
  </body>
</html>